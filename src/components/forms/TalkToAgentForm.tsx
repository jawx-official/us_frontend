            ...
            >
                {(props) => (
                    <Form>
                        ...
                        <FormControl>
                            <FormHelperText>
                                You're creating an account with Urbanspaces and agree to our <Text as={'span'} color={"blue.400"}>Terms of use</Text> and <Text as={'span'} color={"blue.400"} >Privacy Policy</Text>
                            </FormHelperText>
                        </FormControl>
                    </Form>
                )}
